...
namespace Msramdan\Generator\Generators\Views;

use Msramdan\Generator\Generators\GeneratorUtils;
                ...
                switch ($request['column_types'][$i]) {
                    ...
                    case 'boolean':
                        switch ($request['input_types'][$i]) {
                            case 'select':
                                // select
                                $options = "<option value=\"1\" {{ isset($" . $modelNameSingularCamelCase . ") && $" . $modelNameSingularCamelCase . "->$fieldSnakeCase == '1' ? 'selected' : (old('$fieldSnakeCase') == '1' ? 'selected' : '') }}>{{ __('True') }}</option>\n\t\t\t\t<option value=\"0\" {{ isset($" . $modelNameSingularCamelCase . ") && $" . $modelNameSingularCamelCase . "->$fieldSnakeCase == '0' ? 'selected' : (old('$fieldSnakeCase') == '0' ? 'selected' : '') }}>{{ __('False') }}</option>";
